                ...
                <div className="bg-linear-to-br from-black to-violet-600 w-full">
                    <Container maxWidth="xl">
                        <Toolbar disableGutters>
                            <EqualizerIcon className="hidden md:flex mr-1 animate-pulse text-cyan-700 text-2xl"/>
                                <p className="font-rubik-iso text-xl font-semibold text-cyan-700 tracking-widest pr-0 md:pr-[15px]">Albums</p>
